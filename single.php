			...
			<div class="list-inline section-custom">
				...
				<div class="section-content section-right item-inline">
					...
					<div class="single-date flex-item">
						<p class="news-view"><a class="font300"><?php echo $post_terms[0]->name; ?></a> <span class="fontita font16"><i class="fa fa-calendar"></i><?php echo get_the_date('d/m/Y');  ?> &nbsp; /&nbsp;&nbsp;<i class="fa fa-eye"></i><?php echo $viewupdate;?></span></p>
					...
					<section class="related-posts">
						...
						<div class="news-item flex-item">
							...
							<div class="news-infor">
								...
								<p class="news-view"><a class="font300"><?php echo $post_terms[0]->name; ?></a> <span class="fontita">
								<?php if($view_numbers){?>
									<i class="fa fa-eye"></i><?php echo $view_numbers;?>
								<?php } ?>
								</span>
								</p>
